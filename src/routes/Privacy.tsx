    ...
    <>
      ...
      <section className={styles.container}>
        ...
        <p>
          ...
          CODA Intelligence. By accessing or using our Service, you signify that
        ...
        <ul>
          ...
          <li>
            ...
            it refers to CODA Intelligence.io INC, (302 N Last Chance Gulch Ste
            409 Helena, MT 59601) that is responsible for your information under
            this Privacy Policy.
          </li>
          <li>
            Country: where CODA Intelligence or the owners/founders of CODA
            Intelligence are based, in this case is United States
          </li>
          <li>
            Customer: refers to the company, organization or person that signs
            up to use the CODA Intelligence Service to manage the relationships
            with your consumers or service users.
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit CODA
            Intelligence and use the services.
          </li>
          <li>
          ...
          <li>
            Personnel: refers to those individuals who are employed by CODA
            Intelligence or are under contract to perform a service on behalf of
            one of the parties.
          </li>
          <li>
          ...
          <li>
            Service: refers to the service provided by CODA Intelligence as
          ...
          <li>
            Website: CODA Intelligence.&#8221;’s&#8221; site, which can be
            accessed via this URL: www.sellbigger.com
          </li>
          <li>
            You: a person or entity that is registered with CODA Intelligence to
            use the Services.
          </li>
        </ul>
        ...
        <h2>
          When does CODA Intelligence use end user information from third
          parties?
        </h2>
        <p>
          CODA Intelligence will collect End User Data necessary to provide the
          CODA Intelligence services to our customers.
        </p>
        <p>
        ...
        <h2>
          When does CODA Intelligence use customer information from third
          parties?
        </h2>
        <p>
          ...
          interest in becoming a CODA Intelligence customer, we receive
          information from a third party that provides automated fraud detection
          services to CODA Intelligence. We also occasionally collect
        ...
        <p>
          CODA Intelligence will collect personal information that you submit to
        ...
        <p>
          We keep your information only so long as we need it to provide CODA
          Intelligence to you and fulfill the purposes described in this policy.
        ...
        <p>
          ...
          absolute security of any information you transmit to CODA Intelligence
        ...
        <p>
          CODA Intelligence is incorporated in United States. Information
        ...
        <h2>
          Is the information collected through the CODA Intelligence Service
          secure?
        </h2>
        <p>
        ...
        <p>
          ...
          information CODA Intelligence collects depend on your relationship
          with CODA Intelligence. Personnel may update or correct their
        ...
        <h2>Personnel</h2>
        <p>
          If you are a CODA Intelligence worker or applicant, we collect
        ...
        <p>
          ...
          of the assets of CODA Intelligence or any of its Corporate Affiliates
          (as defined herein), or that portion of CODA Intelligence or any of
        ...
        <p>
          ...
          control with CODA Intelligence, whether by ownership or otherwise. Any
        ...
        <p>
          By using CODA Intelligence or contacting us directly, you signify your
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by CODA
          Intelligence. We are not responsible for the content, accuracy or
        ...
        <h2>Cookies</h2>
        <p>
          CODA Intelligence uses Cookies to identify the areas of our website
        ...
        <p>
          ...
          <br />
          You acknowledge and agree that CODA Intelligence shall not be
          ...
          decency, quality or any other aspect thereof. CODA Intelligence does
        ...
        <p>
          CODA Intelligence uses &#8220;Sessions&#8221; to identify the areas of
          our website that you have visited. A Session is a small piece of data
        ...
        <p>
          ...
          right thing to do. At CODA Intelligence we strongly believe that your
        ...
        <p>
          ...
          requirements of GDPR. CODA Intelligence processes or stores all
        ...
        <ul>
          <li>Via Email: support@codaintelligence.com</li>
          <li>Via this Address: 127 Main St, STE 4, Nashua, NH 03060</li>
        </ul>
      </section>
      <Footer />
    </>
